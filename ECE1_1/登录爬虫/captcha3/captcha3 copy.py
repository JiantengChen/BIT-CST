...
def image_detection(image_path: str, det, poses: Dict) -> None:
    ...
    cv2.imwrite("captcha3\\result_captcha3_screenshot.png", im)
...
def login() -> None:
    ...
    def pic_recognition() -> None:
        ...
        """
        time.sleep(1)
        page.locator(".geetest_tip_img >> nth=0").screenshot(
            path='captcha3\captcha3_screenshot_click_order.png')
    ...
    def captcha3_operation():
        ...
        while(1):
            try:
                ...
                with open("captcha3\captcha3_screenshot_click_order.png", 'rb') as f:
                    image = f.read()
                res = ocr.classification(image)
                print(res)
                with open("captcha3\captcha3_screenshot", 'rb') as f:
                    image = f.read()
                res = ocr.classification(image)
                print(res)
